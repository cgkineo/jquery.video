var ResizeComponent = Video.Component.extend({

  video: null,

  constructor: function ResizeComponent(video) {
    this.video = video;
  ...
  onResize: function() {
    if (!this.video.el.offsetParent) return;
...
Video.ResizeComponent = ResizeComponent;
Video.ui.components.add("ResizeComponent");
